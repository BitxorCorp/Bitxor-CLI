...
describe('Resolution Statement Views', () => {
    it('Renders a token resolution statements', () => {
        const statementsView: any[][] | null = new ResolutionStatementViews(statement.tokenResolutionStatements).render();
        ...
        expect(statementsView[0][0].title.content).equal('Token statement 1 of 1');
