...
describe('AggregateCompleteView', () => {
    it('should return a view', () => {
        ...
        expect(view['[Inner tx. 1 of 2] Token (1/1)']).equal('1 D525AD41D95FCF29');
        ...
        expect(view['[Inner tx. 2 of 2] Token (1/2)']).equal('1 D525AD41D95FCF29');
        expect(view['[Inner tx. 2 of 2] Token (2/2)']).equal('1,234,567,890 BitxorBXR (E74B99BA41F4AFEE)');
    });
});
