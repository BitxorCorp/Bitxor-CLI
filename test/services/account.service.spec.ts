...
import { Address, NamespaceId, NetworkType } from 'bitxor-sdk';
...
describe('Account service', () => {
    ...
    it('should generate accounts from mnemonic', () => {
        ...
        const generatedAccounts = AccountService.generateAccountsFromMnemonic(mnemonic, NetworkType.TEST_NET, Network.BITXOR);
