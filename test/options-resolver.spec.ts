...
describe('OptionsResolver', () => {
    ...
    it('should return the value', async () => {
        const value = await OptionsResolver({ name: 'bitxor' }, 'name', () => undefined, 'Insert your name', 'text', undefined);
        expect(value).to.be.equal('bitxor');
    });
    ...
    it('should return the secondSource value', async () => {
        const value = await OptionsResolver({}, 'name', () => 'bitxor', 'Insert your name', 'text', undefined);
        expect(value).to.be.equal('bitxor');
    });
...
describe('OptionsChoiceResolver', () => {
    ...
    it('should return the value', async () => {
        const choices = [
            { title: 'bitxor', value: 0 },
            { title: 'mijin', value: 1 },
        ];
        const value = await OptionsChoiceResolver({ name: 'bitxor' }, 'name', 'Select name:', choices, 'select', undefined);
        expect(value).to.be.equal(0);
    });
