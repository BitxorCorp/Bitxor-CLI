...
import { NetworkType, Password, SimpleWallet } from 'bitxor-sdk';
...
const networkCurrency = NetworkCurrency.createFromDTO({ namespaceId: 'BitxorBXR', divisibility: 6 });
...
describe('HdProfile MainNet', () => {
    ...
    it('should create a DTO', () => {
        const DTO: HdProfileDTO = {
            ...
            networkCurrency: { namespaceId: 'BitxorBXR', divisibility: 6 },
            version: 3,
            default: '1',
            type: 'HD',
