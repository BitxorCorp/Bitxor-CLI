...
import { ExtendedKey, MnemonicPassPhrase, Network, Wallet } from 'bitxor-hd-wallets';
...
export class DerivationService {
     ...
     * @returns {string}
     */
    public static getPrivateKeyFromMnemonic(mnemonic: string, networkType: NetworkType): string {
        return this.getPrivateKeyFromMnemonicWithCurve(mnemonic, networkType, Network.BITXOR);
    }
     ...
     * @param networkType Bitxor network type
     * @returns {string}
     */
