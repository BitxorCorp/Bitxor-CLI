...
import { IListener, SignedTransaction, Transaction, TransactionAnnounceResponse, TransactionRepository, TransactionType } from 'bitxor-sdk';
            ...
            (ignored) => {
                ...
                console.log(
                    FormatterService.info(
                        "To check if the network confirms or rejects the transaction, run the command 'bitxor-cli transaction status'",
                    ),
                );
            },
            (err) => {
