...
import { Deadline, PlainMessage, PublicAccount, TransactionType, TransferTransaction } from 'bitxor-sdk';
...
export default class extends AnnounceTransactionsCommand {
    ...
    async execute(options: CommandOptions) {
        ...
        const zeroValueTokens = await new TokensResolver().resolve({ tokens: '@BitxorBXR::0' });
