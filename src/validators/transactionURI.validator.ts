...
import { TransactionURI } from 'bitxor-uri-scheme';
    ...
    validate(value: string): boolean | string {
        try {
            ...
            return (
                ...
                'Example: web+bitxor://transaction?data=:data&generationHash=:generationHash&nodeUrl=:nodeUrl&webhookUrl=:webhookUrl'
            );
        }
        return true;
    }
