...
export abstract class ProfileCommand extends Command {
        ...
        try {
            ...
            throw new ExpectedError(
                "Can't retrieve the current profile." +
                    "Use 'bitxor-cli profile list' to check whether the profile exist, " +
                    "if not, use 'bitxor-cli profile create' to create a new profile",
            );
        }
    }
    ...
    protected getDefaultProfile(): Profile {
        try {
            ...
            throw new ExpectedError(
                "Can't retrieve the default profile." + "Use 'bitxor-cli profile create' to create a new default profile",
            );
        }
    }
